 ...
 */
public class Task5EventCorefVersion4 {
    ...
    static public void main(String[] args) {
        ...
        /// establish identity according to matchsettings and merge incidents and subevents
                ...
                HashMap<String, ArrayList<Statement>> containerIncidents = getIncidentsAndSubEventThroughIDAP(taskEventSubType, typedFiles, seckgMap, matchSettings);
    ...
    static HashMap<String, ArrayList<Statement>> getIncidentsAndSubEventThroughIDAP (String taskEventSubType, ArrayList<File> containerTrigFiles,
          ...
          for (int i = 0; i < containerTrigFiles.size(); i++) {
              File trigFile = containerTrigFiles.get(i);
              vu.cltl.triple.objects.TrigTripleData trigTripleData = vu.cltl.triple.read.TrigTripleReader.readTripleFromTrigFile(trigFile);
              ...
              documentEventIndex.put(trigFile.getName(), domainEvents);
          ...
          // the documentEventIndex contains all domain events (incidents and subevents) for each trigfile
          ...
          System.out.println("Nr of incidents, indicentTrigFileIndex.size() = " + indicentTrigFileIndex.size());

          containerIncidents =
                  DocumentIdentity.getLoadedIndicentAndSubeventsEventsWithStatements(taskEventSubType,
                              documentEventIndex,
                              indicentTrigFileIndex,
                              eckgMap,
                              seckgMap);
